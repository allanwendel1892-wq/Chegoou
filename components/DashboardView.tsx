...
import { ArrowUpRight, DollarSign, ShoppingBag, Sparkles, Activity } from 'lucide-react';
...
const DashboardView: React.FC<DashboardViewProps> = ({ salesData, orders }) => {
  ...
  // Logic: Count orders generated by AI (ID starts with 'ord-ia')
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-medium text-gray-500">Vendas por IA</p>
          ...
          <div className="flex items-center mt-4 text-indigo-600 text-sm font-medium">
            ...
            <span className="text-gray-400 ml-1 font-normal">via WhatsApp Bot</span>
          </div>
        </div>
      </div>
