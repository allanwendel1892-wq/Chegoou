...
const DashboardView: React.FC<DashboardViewProps> = ({ salesData, aiOrdersCount }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-medium text-gray-500">Pedidos via IA</p>
              <h3 className="text-2xl font-bold text-gray-900 mt-1">{aiOrdersCount}</h3>
            </div>
            <div className="p-2 bg-purple-50 rounded-lg">
          ...
          <div className="flex items-center mt-4 text-gray-400 text-sm font-medium">
            <span className="font-normal">Total acumulado</span>
          </div>
        </div>
      </div>
